...
import {createProducts, getAPI} from '../pages/API'
...
function Newproduct(props) {
    ...
    const onClickSave = () =>{
        createProducts(name, description, quantity, price, category)
            .then(() => {
                    ...
                    <DialogContent sx={{width: '500px'}}>
                        <DialogContentText id="alert-dialog-description">
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                ...
                                <input className="input2" type="text" value={description}  onChange={onChangeDes}/>
                                <label  htmlFor="">Quantity</label>
                                <input className="input2" type="text" value={quantity} onChange={onChangeQuantity}/>
                                <label htmlFor="">Price</label>
                                <input className="input2" type="text" value={price} onChange={onChangePrice} />
                                <label htmlFor="">Category</label>
                                <div className="select-dropdown-new">
                                    <select value={category} onChange={onChangeCate}>
